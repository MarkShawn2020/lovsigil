      ...
      {isMobile ? (
        ...
        <div className="flex-1 min-h-0 relative flex flex-col bg-bg-dark">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6">
            ...
            <Button
              ...
              size="lg"
              className="gradient-gold-copper px-8"
            >
          ...
          <div className="shrink-0 px-4 pb-4 safe-area-bottom">
            <div className="flex items-center justify-center">
              {authLoading ? (
                ...
                <div className="flex items-center gap-3 px-4 py-2 bg-bg-card rounded-full border border-primary/20">
                  <div className="w-7 h-7 rounded-full bg-primary/20 flex items-center justify-center text-primary text-sm font-medium overflow-hidden">
                  ...
                  <Link href="/credits" className="text-sm text-muted-foreground flex items-center gap-1">
                ...
                <Button onClick={() => signInWithGoogle()} variant="outline" size="sm" className="border-primary/30">
        ...
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center relative">
          ...
          <div className="mt-6 flex items-center gap-4">
            {/* 已拍照：显示头像 + 生成按钮 */}
            {capturedThumbnail ? (
              <div className="flex items-center gap-3 px-4 py-3 bg-[#1A1A1E] rounded-2xl border-2 border-primary/50">
            ...
            {/* 用户信息 */}
            <div className="px-3 py-2 bg-[#1A1A1E] rounded-xl border-2 border-primary/50">
              {authLoading ? (
                <div className="h-8 w-8 flex items-center justify-center">
                  <div className="h-4 w-4 animate-spin rounded-full border-2 border-primary border-t-transparent" />
                </div>
            ...
            {/* 工具栏 */}
            <div className="flex items-center gap-1 px-2 py-2 bg-[#1A1A1E] rounded-xl border-2 border-primary/50">
              <Link
                href="/gallery"
