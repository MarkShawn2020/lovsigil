...
export const generateMetadata = async (props: {
  ...
  const metadataByLocale = {
    zh: {
      title: {
        default: 'LannaMirror3 - 生产就绪的 Next.js SaaS 模板',
        template: '%s | LannaMirror3',
      },
      description: '基于 Next.js 15、Supabase 和 Tailwind CSS 的全栈 SaaS 模板。包含认证、数据库、UI 组件等开箱即用。',
      keywords: ['Next.js', 'SaaS模板', 'Supabase', 'Tailwind CSS', 'React', 'TypeScript', 'LannaMirror3'],
      ogLocale: 'zh_CN',
      ogTitle: 'LannaMirror3 - 生产就绪的 Next.js SaaS 模板',
      ogDescription: '基于 Next.js 15、Supabase 和 Tailwind CSS 的全栈 SaaS 模板，快速启动您的下一个项目。',
      twitterTitle: 'LannaMirror3 - Next.js SaaS 模板',
      twitterDescription: '生产就绪的 Next.js SaaS 模板，包含认证、数据库、UI 组件等。',
      ogImageAlt: 'LannaMirror3 - Next.js SaaS Starter',
    },
    en: {
      title: {
        default: 'LannaMirror3 - Production-ready Next.js SaaS Starter',
        template: '%s | LannaMirror3',
      },
      ...
      keywords: ['Next.js', 'SaaS template', 'Supabase', 'Tailwind CSS', 'React', 'TypeScript', 'LannaMirror3'],
      ogLocale: 'en_US',
      ogTitle: 'LannaMirror3 - Production-ready Next.js SaaS Starter',
      ...
      twitterTitle: 'LannaMirror3 - Next.js SaaS Starter',
